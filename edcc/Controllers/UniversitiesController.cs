...
namespace edcc.Models
{
    public class UniversitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "un_id,un_name,un_description")] University university)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "un_id,un_name,un_description")] University university)
        {
            if (ModelState.IsValid)
            {
